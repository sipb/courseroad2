        ...
        <v-card-text class="card-body">
          <div id="cardBody" class="card-body-container">
            ...
            <h4 v-if="currentSubject.is_historical">
              ...
              {{ currentSubject.source_semester.split("-").join(" ") }})
            </h4>
            <h4 v-else-if="currentSubject.not_offered_year">
              <v-icon small> mdi-alert </v-icon>
              This subject is not offered during the
              {{ currentSubject.not_offered_year }} school year.
            </h4>
            <table cellspacing="4">
              <tr v-if="currentSubject.total_units !== undefined">
                ...
                <td data-cy="cardUnits">
                  ...
                  <span
                    v-if="
                      currentSubject.lecture_units !== undefined &&
                      currentSubject.lab_units !== undefined &&
                      currentSubject.preparation_units !== undefined
                    "
                  >
                    total ({{ currentSubject.lecture_units }}-{{
                      currentSubject.lab_units
                    }}-{{ currentSubject.preparation_units }})
                  </span>
                </td>
              </tr>
              <tr
                v-if="
                  currentSubject.offeredFall !== undefined ||
              ...
              <tr
                v-if="currentSubject.virtual_status !== undefined"
                data-cy="cardVirtual"
              >
                <td><b>Virtual</b></td>
                <td
                  v-if="currentSubject.virtual_status === 'Virtual/In-Person'"
                >
                  Partly Virtual
                </td>
              ...
              <tr
                v-if="currentSubject.instructors !== undefined"
                data-cy="cardInstructors"
              >
                <td><b>Instructor</b></td>
                <td>
                  <ul class="comma-separated">
                    <li
                      v-for="instructor in currentSubject.instructors"
                      :key="instructor"
                    >
                      {{ instructor }}
                    </li>
              ...
              <tr
                v-if="
                  currentSubject.in_class_hours !== undefined ||
                  currentSubject.out_of_class_hours !== undefined
                "
                data-cy="cardHours"
              >
                <td>
                ...
                <td>
                  <table cellspacing="0">
                    <tr v-if="currentSubject.in_class_hours !== undefined">
                      {{
                        currentSubject.in_class_hours.toFixed(2)
                      }}
                      in class
                    </tr>
                    <tr v-if="currentSubject.out_of_class_hours !== undefined">
                      {{
                        currentSubject.out_of_class_hours.toFixed(2)
                      }}
                      out of class
                    </tr>
                  </table>
            ...
            <p v-if="currentSubject.url !== undefined">
              <a target="_blank" :href="currentSubject.url"
            ...
            <div
              v-if="currentSubject.related_subjects !== undefined"
