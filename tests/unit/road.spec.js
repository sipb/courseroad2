...
describe('Road', () => {
  ...
  it('opens the changeYearDialog', () => {
    const wrapper = mount(Road, { stubs: ['semester'], propsData: { selectedSubjects: [[{ subject_id: 1 }], [{ subject_id: 2 }], [], [], [], [], [], [], [], [], [], [], [], [], [], []], roadID: '1', addingFromCard: false, dragSemesterNum: 1 }, store, localVue, mocks: { $cookies: { get: () => false, remove: () => false } } });
