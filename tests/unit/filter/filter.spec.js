...
function testFilter(FilterType, args, matching, nonmatching) {
  ...
  describe("Filters", () => {
    ...
    */
    ...
    it(
      "lets all subjects match a zero-attribute AND " + FilterType.name,
      () => {
    ...
    it(
      "fails non-matching subjects against a one-attribute OR " +
        FilterType.name,
      () => {
    ...
    it(
      "passes matching subjects against a one-attribute OR " + FilterType.name,
      () => {
    ...
    it(
      "fails non-matching subjects against a one-attribute AND " +
        FilterType.name,
      () => {
    ...
    it(
      "passes matching subjects against a one-attribute AND " + FilterType.name,
      () => {
    ...
    // covers this.attributeNames.length > 1, 'OR', doesn't match, all failing attributes
    it(
      "fails non-matching subjects against a multi-attribute OR " +
        FilterType.name,
      () => {
    ...
    it(
      "passes semi-matching subjects against a multi-attribute OR " +
        FilterType.name,
      () => {
        const f = new FilterType(
          "test",
          "t",
          ...args,
          ["x", "y", "z", "w"],
    ...
    // covers this.attributeNames.length > 1, 'OR', matches, 0 failing attributes
    it(
      "passes matching subjects against a multi-attribute OR " +
        FilterType.name,
      () => {
    ...
    // covers this.attributeNames.length > 1, 'AND', doesn't match, all failing attributes
    it(
      "fails non-matching subjects against a multi-attribute AND " +
        FilterType.name,
      () => {
    ...
    it(
      "fails semi-matching subjects against a multi-attribute AND " +
        FilterType.name,
      () => {
        const f = new FilterType(
          "test",
    ...
    // covers this.attributeNames.length > 1, 'AND', matches, 0 failing attributes
    it(
      "passes matching subjects against a multi-attribute AND " +
        FilterType.name,
      () => {
        const f = new FilterType(
          "test",
...
testFilter(
  RegexFilter,
  ["^ca.+", ""],
  ["cat", "car", "camera", "cab", "candid"],
  ["arcade", "ca", "coat", "orca", "act"],
);
...
testFilter(
  ArrayFilter,
  [RegexFilter, ["ra", ""]],
  [["rage", "range"], ["random", "look"], ["hi", "ramp"], ["radio"], ["rail"]],
  [[], ["list", "hello"], [], [], ["one"]],
);
