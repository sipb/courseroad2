...
describe("ClassSearch", () => {
  ...
  */
  ...
  it("shows no results with empty search", () => {
    const store = new Vuex.Store({
      state: {
        genericCourses: [],
        subjectsInfo: [
          { title: "Global Change Science", subject_id: "1.071" },
    ...
    const wrapper = mount(ClassSearch, {
      store,
      localVue,
      propsData,
      sync: false,
  ...
  it("displays correct results with regex title search", async () => {
    const store = new Vuex.Store({
      state: {
        genericCourses: [],
        subjectsInfo: [
          { title: "Introductory Biology", subject_id: "7.016" },
  ...
  it("displays correct results with class title search", async () => {
    const store = new Vuex.Store({
      state: {
        ...
        subjectsInfo: [
          ...
          {
            title: "Engineering Sustainability: Analysis and Design",
            subject_id: "1.020",
          },
    ...
    const expectedResults = [
      { title: "Engineering Computation and Data Science", subject_id: "1.00" },
      {
        title: "Engineering Sustainability: Analysis and Design",
        subject_id: "1.020",
      },
  ...
  it("displays correct results with class number search", async () => {
    const store = new Vuex.Store({
      state: {
        genericCourses: [],
        subjectsInfo: [
          { title: "Introduction to Design", subject_id: "2.00" },
  ...
  it("displays correct results with filter search", async () => {
    const store = new Vuex.Store({
      state: {
        genericCourses: [],
        subjectsInfo: [
          { title: "Climate Change", subject_id: "1.009", total_units: 3 },
          {
            title: "Probability and Causal Inference",
            subject_id: "1.010",
            total_units: 12,
          },
          {
          ...
          {
            title: "How to Design (Almost) Anything",
            subject_id: "4.141",
            total_units: 18,
          },
  ...
  it("displays correct results with multiple filter group search", async () => {
    const store = new Vuex.Store({
      state: {
        genericCourses: [],
        subjectsInfo: [
          { title: "Groundwater Hydrology", subject_id: "1.072" },
    ...
    const store = new Vuex.Store({
      state: {
        ...
        subjectsInfo: [
          ...
          {
            title: "Fundamentals of Smart and Resilient Grids",
            subject_id: "2.603",
            offered_fall: true,
            total_units: 12,
          },
          ...
          {
            title: "Fundamentals of Chemical Biology",
            subject_id: "5.08",
            offered_fall: false,
            total_units: 12,
          },
