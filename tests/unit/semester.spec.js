...
describe("Semester", () => {
  ...
  it("calculates noLongerOffered correctly", () => {
    ...
    expect(
      wrapper.vm.noLongerOffered({
        is_historical: true,
        source_semester: "spring-2013",
      }),
    ).toEqual(true);
    expect(
      wrapper.vm.noLongerOffered({
    ...
    expect(
      wrapper.vm.noLongerOffered({
        is_historical: true,
        source_semester: "fall-2013",
      }),
    ).toEqual(false);
    expect(
      wrapper.vm.noLongerOffered({
        is_historical: true,
        source_semester: "fall-2012",
      }),
    ).toEqual(true);
    expect(
      wrapper.vm.noLongerOffered({
        is_historical: true,
        source_semester: "spring-2014",
      }),
    ).toEqual(false);
    expect(
      wrapper.vm.noLongerOffered({
        is_historical: true,
        source_semester: "fall-2014",
      }),
    ).toEqual(false);
    jest
      .spyOn(global.Date, "now")
  ...
  it("calculates notCurrentlyOffered correctly", () => {
    ...
    expect(
      wrapper.vm.notCurrentlyOffered({ not_offered_year: "2012-2013" }),
    ).toEqual(false);
    expect(
      wrapper.vm.notCurrentlyOffered({ not_offered_year: "2013-2014" }),
    ).toEqual(true);
    expect(
      wrapper.vm.notCurrentlyOffered({ not_offered_year: "2014-2015" }),
    ).toEqual(false);
    jest
      .spyOn(global.Date, "now")
      .mockImplementationOnce(() =>
  ...
  it("calculates offferedNow correctly", () => {
    ...
    store.state.itemAdding = {
      is_historical: true,
      source_semester: "2010-2011",
      not_offered_year: "2014-2015",
      offered_fall: true,
    };
    expect(wrapper.vm.offeredNow).toEqual(false);
    store.state.itemAdding = {
