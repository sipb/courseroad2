...
describe("Auth Tests", () => {
  ...
  it("Logs in and out", () => {
    ...
    cy.getByDataCy("roadTab123").should("contain", "Best Road Ever").click();
    ...
    cy.getByDataCy("roadTab456").should("contain", "A Good Road").click();
    ...
    cy.getByDataCy("roadTab1089").should("contain", "Example").click();
  ...
  it("Logs in after creating a road with a conflicting name", () => {
    ...
    cy.get(".v-dialog--active").within(() => {
      cy.getByDataCy("renameRoadField").clear().type("A Good Road");
