...
//
//     // Click on class
//     cy.getByDataCy('classInSearch6_004')
//       .click();
//
...
//     cy.get('@freshmanSpring').within(() => {
//       cy.getByDataCy('classInSemester3_6_004')
...
//     // Check the class is now in the semester
//     cy.get('@sophomoreFall').within(() => {
//       cy.getByDataCy('classInSemester4_6_004')
//         .should('contain', 'Computation Structures');
//     });
//   });
//
...
//
//     // Click on class
//     cy.getByDataCy('classInSearch5_111')
//       .click();
//
...
//     cy.getByDataCy('closeClassInfoButton')
//       .click();
//
...
//     cy.get('@juniorFall').within(() => {
//       cy.getByDataCy('semesterUnits')
//         .should('contain', 'Units: 24');
//     });
//   });
//
...
//       cy.getByDataCy('filterButton_HASS:Any')
//         .click();
//     });
//
...
//       .type('7.');
//
//     cy.getByDataCy('classInSearch18_03')
//       .should('not.exist');
//
//     cy.getByDataCy('classInSearch7_012')
//       .should('exist');
//   });
//
...
//     cy.getByDataCy('classInSearch5_12')
//       .click();
//
...
//       .click();
//
//     cy.getByDataCy('classInSearch10_466')
//       .click();
//
...
//       .click();
//
//     cy.getByDataCy('classInSearch24_118')
//       .click();
//
...
//     cy.get('@freshmanFall').within(() => {
//       cy.getByDataCy('classInSemester1_5_12')
//         .should('exist');
//     });
//
//     cy.get('@freshmanSpring').within(() => {
//       cy.getByDataCy('classInSemester3_10_466')
//         .should('exist');
//     });
//
//     cy.get('@freshmanSpring').within(() => {
